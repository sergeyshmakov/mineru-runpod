...
| `probe is disabled on this endpoint` | The endpoint sets `MINERU_DISABLE_PROBE=1` | Read the layout from a worker log line, or unset the variable on an endpoint you own |
