...
| Setting | Value | Why |
|---|---|---|
| `gpu_ids` | `ADA_24` | 24 GB Ada / RTX 4090. Fits the [`MinerU2.5-Pro-2604-1.2B` VLM](https://huggingface.co/opendatalab/MinerU2.5-Pro-2604-1.2B) comfortably with KV cache; faster per page than the cheaper A5000 (`AMPERE_24`). |
