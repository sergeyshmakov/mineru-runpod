...
[MinerU 2.5](https://github.com/opendatalab/MinerU) produces Markdown and structured JSON from complex PDFs, with published results in the [`MinerU2.5-Pro-2605-1.2B` model card](https://huggingface.co/opendatalab/MinerU2.5-Pro-2605-1.2B). Its open-source license is based on Apache 2.0 with additional terms. The 1.2B model fits on a 24 GB GPU, and RunPod Serverless scales to zero when nothing is calling.
